...
def cal_propensity_score():
    ...
    propensity_score = [P] * item_num  # 【改进】每个标签的倾向得分是一样的
...
def train_CausE():
    ...
    model = getattr(models,
                    opt.model)(train_data.users_num, train_data.items_num,
                               opt.embedding_size, opt.reg_c, opt.reg_t,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='CausE')  # MF_Naive MF_IPS CausE 换模型的话，改这里的参数
