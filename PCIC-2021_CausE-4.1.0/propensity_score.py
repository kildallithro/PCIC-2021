...
def cal_propensity_score():
    ...
    # propensity_score = P_L_TO / P_L_T
    propensity_score_c = (threhold_c * P_L_TO_c + (1 - threhold_c) * P_L_TR) / P_L_T
    propensity_score_t = (threhold_t * P_L_TO_t + (1 - threhold_t) * P_L_TR) / P_L_T
